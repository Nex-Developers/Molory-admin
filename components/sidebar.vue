...
<template>
  <div
    class="flex flex-col justify-between items-center flex-none w-20 h-full border-r border-gray-200"
  >
    <div class="flex flex-col space-y-4 w-full items-center pt-5">
      ...
      <NuxtLink to="/campaign" class="text-gray-600" activeClass="active-link">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="w-6 h-6 fill-current"
          viewBox="0 0 512 512"
      ...
      <div class="relative">
        ...
        <div
          class="absolute w-30 z-50 shadow-lg px-2 bg-white"
          v-if="displayMenu"
        >
