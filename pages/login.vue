  ...
  <div class="h-screen bg-gradient-to-b from-white to-blue-200 dark:bg-gradient-to-b dark:from-slate-800 dark:to-slate-400">
    <div class="flex items-center justify-center  px-4 sm:px-6 lg:px-8">
      <div class="max-w-md w-full space-y-8">
        <div>
          <div class="pt-5 h-25 w-25">
          </div>
          <div class="flex">
          <img class="mx-auto h-36 w-auto" src="/img/logo.png" alt="molory logo" />
          <!-- <h1 class="py-9 text-center text-5xl font-extrabold text-gray-900 dark:text-gray-400">Molory </h1> -->
          </div>
        ...
        <form v-if="true" v-on:submit.prevent class="mt-8 space-y-6" action="#" method="POST">
          ...
          <div>
            <button @click.prevent="postLoginForm"
              class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-secondary hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
