            ...
            >
              ...
              <div class="w-1/2">
                <div class="flex items-center">
                  <img
                    :src="contact.avatar || 'img/user.jpeg'"
                  ...
                  <div class="ml-4">
                    <span class="capitalize block text-gray-800"
                      ...
                      <span class="text-gray-600 text-xs"
                        >({{ contact.signUpMethod }})</span
                      ></span
                    >
                    <span
                      class="text-sm block text-gray-600"
                      v-if="contact.signUpMethod == 'phoneNumber'"
                      >{{ contact.phoneNumber }}
                    </span>
                    <span
                      class="text-sm block text-gray-600"
                      v-if="contact.signUpMethod == 'email'"
                      >{{ contact.email }}
                    </span>
                  </div>
                </div>
